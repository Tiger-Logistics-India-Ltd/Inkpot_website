  ...
  return (
    <>
      ...
      <main style={{ background: "#ffffff" }}>
        ...
        {/* ── HERO ── */}
        <section style={{ position: "relative", height: isMobile ? "60vh" : "100vh", minHeight: isMobile ? "420px" : "700px", overflow: "hidden" }}>
          <Image
          ...
          />
          <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to bottom, rgba(0,0,0,0.08) 0%, rgba(0,0,0,0.48) 48%, rgba(0,0,0,0.84) 100%)" }} />

          <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "0 24px", zIndex: 10, pointerEvents: "none" }}>
            <motion.p
            ...
            <motion.h1
              ...
              style={{ fontFamily: "var(--font-heading)", fontStyle: "italic", fontWeight: 400, fontSize: isMobile ? "clamp(32px, 9vw, 52px)" : "clamp(44px, 6.5vw, 92px)", lineHeight: 1.05, color: "#ffffff", maxWidth: "960px" }}
            >
            ...
            <motion.div
              ...
              style={{ width: "40px", height: "1px", background: "rgba(255,255,255,0.3)", margin: "24px auto 0" }}
            />
          </div>
          ...
          <motion.p
            ...
            style={{ position: "absolute", bottom: isMobile ? "16px" : "48px", right: isMobile ? "16px" : "48px", zIndex: 10, fontFamily: "var(--font-body)", fontSize: "10px", letterSpacing: "0.14em", color: "rgba(255,255,255,0.88)", fontWeight: 700 }}
          >
        ...
        {/* ── ORIGIN STORY ── */}
        <section id="our-story" style={{ background: "#ffffff", padding: isMobile ? "56px 0" : "128px 0" }}>
          <div style={{
            ...
            {isMobile && (
              <div style={{ width: "100%", height: "300px", overflow: "hidden", flexShrink: 0 }}>
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: isMobile ? "18px" : "32px" }}>
              ...
              <h2 style={{ fontFamily: "var(--font-heading)", fontStyle: "italic", fontWeight: 400, fontSize: isMobile ? "28px" : "clamp(30px, 3.5vw, 50px)", lineHeight: 1.15, color: "#1a1a1a", marginBottom: isMobile ? "18px" : "32px" }}>
                Born from a belief that India&rsquo;s greatest stories deserve a better stage.
              </h2>
              <p style={{ fontFamily: "var(--font-body)", fontSize: isMobile ? "13px" : "15px", lineHeight: 1.88, color: "rgba(0,0,0,0.6)", marginBottom: "16px" }}>
              ...
              <p style={{ fontFamily: "var(--font-body)", fontSize: isMobile ? "13px" : "15px", lineHeight: 1.88, color: "rgba(0,0,0,0.6)" }}>
            ...
            {!isMobile && (
              ...
              >
                <Image src="/images/Homepage/about/extra.jpg" alt="Inkpot India — the story"
                  fill sizes="50vw" style={{ objectFit: "cover", objectPosition: "center" }} />
              </motion.div>
            )}
          </div>
        </section>
        ...
        <section id="beliefs" style={{ background: "#ffffff", padding: isMobile ? "56px 0" : "128px 0" }}>
          <div style={{ maxWidth: "1280px", margin: "0 auto", padding: isMobile ? "0 20px" : "0 64px" }}>
            <motion.div
              ...
              style={{ marginBottom: isMobile ? "32px" : "72px" }}
            >
              ...
              <h2 style={{ fontFamily: "var(--font-heading)", fontWeight: 400, fontSize: isMobile ? "28px" : "clamp(32px, 3.5vw, 50px)", lineHeight: 1.1, color: "#1a1a1a" }}>
                What We Stand For.
              </h2>
            </motion.div>

            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: "2px", background: "rgba(0,0,0,0.07)" }}>
              {beliefs.map((b, i) => (
                <motion.div
                  key={b.num}
                  initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
                  ...
                  style={{ background: "#ffffff", padding: isMobile ? "28px 24px" : "60px 56px" }}
                >
                  <span style={{ fontFamily: "var(--font-heading)", fontStyle: "italic", fontSize: isMobile ? "40px" : "64px", color: "rgba(144,26,28,0.07)", fontWeight: 400, display: "block", lineHeight: 1, marginBottom: isMobile ? "14px" : "28px" }}>
                    {b.num}
                  </span>
                  <h3 style={{ fontFamily: "var(--font-heading)", fontWeight: 400, fontSize: isMobile ? "18px" : "22px", color: "#1a1a1a", marginBottom: "12px", lineHeight: 1.2 }}>
                    {b.title}
                  </h3>
                  <p style={{ fontFamily: "var(--font-body)", fontSize: isMobile ? "13px" : "14px", lineHeight: 1.88, color: "rgba(0,0,0,0.55)" }}>
                    {b.body}
                  </p>
                </motion.div>
              ))}
        ...
        {/* ── FOUNDER ── */}
        <section id="leadership" style={{ background: "#F7F4EF", padding: isMobile ? "56px 0" : "128px 0" }}>
          <div style={{
            maxWidth: "1280px", margin: "0 auto",
            padding: isMobile ? "0 20px" : "0 64px",
            display: isMobile ? "flex" : "grid",
            ...
            <motion.div
              initial={{ opacity: 0, y: 28 }} whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.2 }}
              transition={{ duration: 0.75, delay: isMobile ? 0 : 0.12, ease: "easeOut" }}
            >
              <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: isMobile ? "18px" : "32px" }}>
                <div style={{ width: "24px", height: "1px", background: "var(--primary-red)" }} />
              ...
              <p style={{ fontFamily: "var(--font-body)", fontSize: isMobile ? "13px" : "15px", lineHeight: 1.88, color: "rgba(0,0,0,0.65)", marginBottom: "16px" }}>
              ...
              <p style={{ fontFamily: "var(--font-body)", fontSize: isMobile ? "13px" : "15px", lineHeight: 1.88, color: "rgba(0,0,0,0.65)", marginBottom: isMobile ? "28px" : "48px" }}>
              ...
              <div style={{ borderTop: "1px solid rgba(0,0,0,0.1)", paddingTop: "24px" }}>
                <p style={{ fontFamily: "var(--font-heading)", fontStyle: "italic", fontWeight: 400, fontSize: isMobile ? "19px" : "22px", color: "#1a1a1a", marginBottom: "8px" }}>
                  Simar Malhotra
                </p>
