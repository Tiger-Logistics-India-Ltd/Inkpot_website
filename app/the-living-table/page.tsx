        ...
        <section style={{ background: "#F4EFE6", padding: "clamp(40px, 5vw, 64px) clamp(24px, 8vw, 120px)" }}>
          ...
          <div className="tlt-know-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0 clamp(32px, 6vw, 80px)", maxWidth: "680px" }}>
            {([
              ...
              { icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round"><path d="M2 12h20M2 12a2 2 0 0 0 2-2V7h16v3a2 2 0 0 0 2 2M2 12a2 2 0 0 1 2 2v3h16v-3a2 2 0 0 1 2-2"/><line x1="12" y1="7" x2="12" y2="17"/></svg>, label: "Ticket needed for ages 18 and above" },
              { icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round"><circle cx="12" cy="7" r="4"/><path d="M4 21c0-4 3.6-7 8-7s8 3 8 7"/></svg>, label: "Entry allowed for ages 18 and above" },
