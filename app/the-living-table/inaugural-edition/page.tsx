  ...
  return (
    <>
      ...
      <main style={{ background: "#0A0806" }}>
        ...
        <section className="tlt-hero" style={{ position: "relative", height: "100dvh", minHeight: "480px", overflow: "hidden" }}>
          ...
          <a
            ...
            style={{
              ...
              color: "rgba(244,239,230,0.7)", textDecoration: "none",
        ...
        <section ref={formRef} className="tlt-experience" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", background: "#ffffff", minHeight: "clamp(380px, 48vw, 600px)" }}>
          ...
          >
            ...
            <p style={{
              ...
              An intimate dining experience of food, stories and cultural memory that unfolded in the heart of Old Delhi, hosted within the restored haveli Kathika Cultural Centre.
            </p>
            ...
            <p style={{
              ...
              We were joined by the Gujral family credited with inventing butter chicken, tracing its journey from Peshawar to Delhi through the lens of Partition, memory, migration, and food, exploring how one dish came to carry histories far beyond the table.
            </p>
          ...
          <div className="tlt-why-grid" style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                The Living Table was an attempt to bring those memories back. Not just as food, but as conversation. An evening that asked: what does a city taste like when it remembers itself?
              </p>
            </div>
          </div>
        </div>
        ...
        {/* ── CLOSING CTA — the next edition ── */}
        <section style={{ background: "#0A0806", padding: "clamp(56px, 8vw, 104px) 24px", textAlign: "center" }}>
          <motion.div
            initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.9, ease: [0.22, 1, 0.36, 1] }}
            style={{ maxWidth: "560px", margin: "0 auto" }}
          >
            <p style={{ fontFamily: "var(--font-body)", fontSize: "9px", letterSpacing: "0.34em", textTransform: "uppercase", color: "#C9A84C", margin: "0 0 20px" }}>
              Inkpot India
            </p>
            <h2 style={{ fontFamily: "var(--font-heading)", fontStyle: "italic", fontWeight: 400, fontSize: "clamp(28px, 5vw, 48px)", color: "#F4EFE6", lineHeight: 1.15, margin: "0 0 20px" }}>
              The next table is being set.
            </h2>
            <p style={{ fontFamily: "var(--font-body)", fontSize: "clamp(13px, 1.4vw, 15px)", color: "rgba(244,239,230,0.55)", lineHeight: 1.9, margin: "0 0 36px" }}>
              The inaugural edition has passed into memory. A new evening — new stories, new hands, a new table — is already taking shape. Be the first to know when it opens.
            </p>
            <a
              href="/the-living-table#register"
              style={{
                display: "inline-block", background: "#901A1C", color: "#ffffff",
                padding: "16px 48px", fontFamily: "var(--font-body)", fontSize: "10px",
